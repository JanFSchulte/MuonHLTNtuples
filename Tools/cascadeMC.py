# hltGetConfiguration /online/collisions/2017/2e34/v1.0/HLT/V8 --input root://eoscms.cern.ch//eos/cms/store/mc/RunIISummer17DRStdmix/TT_TuneCUETP8M2T4_13TeV-powheg-pythia8/GEN-SIM-RAW/NZSFlatPU28to62_92X_upgrade2017_realistic_v10-v2/50000/8CAC0136-BFA0-E711-82A8-0025904B2C4C.root --globaltag 92X_upgrade2017_TSG_For90XSamples_V2 --paths HLTriggerFirstPath,HLT_IsoTkMu27_v8,HLT_IsoTkMu27_v8,HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_v7,HLT_TkMu17_TrkIsoVVL_TkMu8_TrkIsoVVL_v4,HLT_Mu50_v6,HLT_Dimuon25_Jpsi_v12,HLT_TkMu50_v4,HLTriggerFinalPath --mc --process TEST --full --offline --output none --l1-emulator FullMC --l1 L1Menu_Collisions2017_v4 --unprescale
...
process.HLTSchedule = cms.Schedule( *(process.HLTriggerFirstPath, process.HLT_IsoTkMu27_v8, process.HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_v7, process.HLT_TkMu17_TrkIsoVVL_TkMu8_TrkIsoVVL_v4, process.HLT_Mu50_v6, process.HLT_TkMu50_v4, process.HLTriggerFinalPath ))
...
if 'GlobalTag' in process.__dict__:
    ...
    process.GlobalTag = customiseGlobalTag(process.GlobalTag, globaltag = '92X_upgrade2017_TSG_For90XSamples_V2', conditions = 'L1Menu_Collisions2017_v4,L1TUtmTriggerMenuRcd,,,9999-12-31 23:59:59.000')
...
_customInfo['globalTag' ]= "92X_upgrade2017_TSG_For90XSamples_V2"
